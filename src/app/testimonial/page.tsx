...
const Page = () => {
  return (
    <div>
      ...
      >
        <h1 className="text-3xl md:text-5xl text-black text-center  font-bold leading-[120%] mt-8">
          Customer Testimonials
        </h1>
        <p className="w-[90%] text-lg font-normal leading-[150%] text-center text-black mt-6 mb-6 md:mb-20">
